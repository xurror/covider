...
import cm.ubuea.covider.registration.repository.PersistenceAuditEventRepository;
...
public class AuditResourceIT {
    ...
    public void getAuditsByDate() throws Exception {
        ...
        final String fromDate = SAMPLE_TIMESTAMP.minusSeconds(SECONDS_PER_DAY).toString().substring(0, 10);
        final String toDate = SAMPLE_TIMESTAMP.plusSeconds(SECONDS_PER_DAY).toString().substring(0, 10);
    ...
    public void getNonExistingAuditsByDate() throws Exception {
        ...
        final String fromDate = SAMPLE_TIMESTAMP.minusSeconds(2 * SECONDS_PER_DAY).toString().substring(0, 10);
        final String toDate = SAMPLE_TIMESTAMP.minusSeconds(SECONDS_PER_DAY).toString().substring(0, 10);
